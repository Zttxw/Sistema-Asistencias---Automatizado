...
export default function VisitanteHome({ onVerAsistencias, onOpenLogin }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col items-center justify-between pb-12 relative overflow-x-hidden">
      {/* Banner Superior de Animación Speeder ocupando TODO el ancho */}
      <div className="w-full h-44 relative mb-6">
        ...
        <button
          onClick={toggleTheme}
          className="absolute top-4 right-4 z-10 p-2 rounded-lg border border-gray-200/80 dark:border-gray-700/80 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm text-gray-600 dark:text-gray-300 hover:bg-white dark:hover:bg-gray-800 transition-colors cursor-pointer shadow-xs"
      ...
      {/* Footer */}
      <div className="mt-8 text-[11px] text-gray-400 dark:text-gray-500 font-medium text-center">
        v1.0.0 &bull; OTI
      </div>
    </div>
  );
