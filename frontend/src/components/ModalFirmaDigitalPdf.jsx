                  ...
                  <div className="pt-2.5 border-t border-gray-100 dark:border-zinc-900 flex items-center justify-between gap-2">
                    {semana.firmado ? (
                      ...
                      <div className="flex items-center gap-1.5 flex-wrap">
                        ...
                        <label className="px-2.5 py-1.5 bg-[#3484A5] hover:bg-[#2b6f8b] text-white text-xs font-bold rounded-lg transition-colors flex items-center gap-1 cursor-pointer shadow-2xs">
