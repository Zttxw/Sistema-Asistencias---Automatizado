...
import { CalendarCheck, Users, Radio, FileText, ShieldCheck, LogIn, LogOut, User, Sun, Moon } from 'lucide-react';
...
export default function Layout() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 font-sans">
      {/* Sidebar fijo — oculto cuando Visitante está en menú de tarjetas */}
      {!hideSidebar && (
        <aside className="w-64 bg-white dark:bg-gray-800 border-r border-gray-100 dark:border-gray-700 flex flex-col shrink-0 fixed inset-y-0 left-0 z-30">
          ...
          <div className="p-4 border-t border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
            {!user ? (
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3 bg-white dark:bg-gray-700 p-2.5 rounded-lg border border-gray-100 dark:border-gray-600 shadow-2xs">
                ...
                <button
                  onClick={logout}
                  className="w-full flex items-center justify-center space-x-2 px-3 py-1.5 border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 text-xs font-medium rounded-lg hover:bg-red-50 dark:hover:bg-red-900/30 hover:text-red-600 dark:hover:text-red-400 hover:border-red-200 dark:hover:border-red-800 transition-colors cursor-pointer"
                >
            ...
            <div className="mt-3 flex items-center justify-between">
              <span className="text-[11px] text-gray-400 dark:text-gray-500 font-medium">v1.0.0 &bull; OTI</span>
              <button
                onClick={toggleTheme}
                className="p-1.5 rounded-md text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors cursor-pointer"
