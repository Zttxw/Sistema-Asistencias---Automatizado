        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full pl-3 pr-10 py-2 bg-white dark:bg-zinc-900 border border-gray-300 dark:border-zinc-800 rounded-none text-sm text-gray-900 dark:text-white focus:outline-none focus:border-emerald-500"
              placeholder="••••••••"
            />
            <button
              type="button"
